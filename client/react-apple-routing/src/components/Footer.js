...
function Footer() {
  ...
  const showhide = () => {
    let hiddenLists = document.getElementsByClassName("hiddenList");
    console.log(hiddenLists);
    // Array.from(hiddenLists).filter((element) => {
    ...
    // for (let i = 0; i < Array.from(hiddenLists).length; i++) {
    //   console.log(Array.from(hiddenLists)[i]);
    if (!ref.current.classList.contains("d-block")) {
      ...
      <div class="container">
        ...
        <div class="footer-links-wrapper row">
          <div class="links-wrapper-1 col-sm-12 col-md">
            <h3 onClick={showhide}>Shop and Learn</h3>
            <ul ref={ref} id="hiddenList">
              <li>
                <a href="#">Mac</a>
              </li>
              <li>
          ...
          <div class="links-wrapper-2 col-sm-12 col-md">
            <h3 onClick={showhide}>Services</h3>
            <ul ref={ref} id="hiddenList">
              <li>
            ...
            <h3 onClick={showhide}>Account</h3>
            <ul ref={ref} id="hiddenList">
              <li>
          ...
          <div class="links-wrapper-3 col-sm-12 col-md">
            <h3 onClick={showhide}>Apple Store</h3>
            <ul ref={ref} id="hiddenList">
              <li>
          ...
          <div class="links-wrapper-4 col-sm-12 col-md">
            <h3 onClick={showhide}>For Business</h3>
            <ul ref={ref} id="hiddenList">
              <li>
            ...
            <h3 onClick={showhide}>For Education</h3>
            <ul ref={ref} id="hiddenList">
              <li>
            ...
            <h3 onClick={showhide}>For Healthcare</h3>
            <ul ref={ref} id="hiddenList">
              <li>
                <a href="#">Manage Your Apple ID</a>
              </li>
            ...
            <h3 onClick={showhide}>For Government</h3>
            <ul ref={ref} id="hiddenList">
              <li>
                <a href="#">Apple and Education</a>
              </li>
          ...
          <div class="links-wrapper-5 col-sm-12 col-md">
            <h3 onClick={showhide}>Apple Values</h3>
            <ul ref={ref} id="hiddenList">
              <li>
                <a href="#">Find a Store</a>
              </li>
            ...
            <h3 onClick={showhide}>About Apple</h3>
            <ul ref={ref} id="hiddenList">
              <li>
                <a href="#">Find a Store</a>
              </li>
